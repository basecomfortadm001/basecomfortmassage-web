...
function getFooter() {
    ...
    <footer class="footer bg-base-gray py-[60px] md:py-16 xl:py-20 2xl:py-24 px-5 md:px-12 xl:px-16 2xl:px-20 border-t border-base-gold text-base-text">
            ...
            <div class="footer-columns grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6 xl:gap-8 2xl:gap-10">
                <div class="footer-column footer-accordion">
                    ...
                    <div class="footer-accordion-content md:block">
                        <p class="text-sm xl:text-sm 2xl:text-base leading-relaxed font-sans">Oudegracht 123<br>3511 AB Utrecht<br>Nederland</p>
                    </div>
                </div>
                ...
                <div class="footer-column footer-accordion">
                    ...
                    <div class="footer-accordion-content md:block">
                        <a href="about-us.html" class="block text-base-text no-underline text-sm xl:text-sm 2xl:text-base mb-2.5 xl:mb-3 2xl:mb-4 font-sans transition-opacity duration-300 hover:opacity-60">Over ons</a>
                        <a href="terms-and-conditions.html" class="block text-base-text no-underline text-sm xl:text-sm 2xl:text-base mb-2.5 xl:mb-3 2xl:mb-4 font-sans transition-opacity duration-300 hover:opacity-60">Algemene Voorwaarden</a>
                    </div>
                </div>
        ...
        <div class="footer-bottom border-t border-base-text/20 pt-5 xl:pt-6 2xl:pt-8 mt-7 xl:mt-9 2xl:mt-10 text-center">
            <p class="copyright text-sm xl:text-sm 2xl:text-base m-0 mb-2 xl:mb-3 2xl:mb-4 font-sans">Alle rechten voorbehouden - Base Comfort 2025</p>
            <div class="footer-legal flex justify-center gap-4 xl:gap-5 2xl:gap-6 m-0 p-0">
                <a href="terms-and-conditions.html#privacy" class="text-base-text no-underline text-sm xl:text-sm 2xl:text-base font-sans transition-opacity duration-300 hover:opacity-60">Privacybeleid</a>
                <a href="terms-and-conditions.html" class="text-base-text no-underline text-sm xl:text-sm 2xl:text-base font-sans transition-opacity duration-300 hover:opacity-60">Algemene Voorwaarden</a>
            </div>
        </div>
    </footer>`;
}
    ...
    <div class="mobile-menu fixed inset-0 z-[999] pointer-events-none opacity-0 transition-opacity duration-500" id="mobileMenu">
        ...
        <div class="mobile-menu-content absolute top-0 left-0 w-4/5 max-w-sm h-full bg-base-cream transform -translate-x-full transition-transform duration-500 ease-in-out shadow-2xl overflow-y-auto">
            <ul class="mobile-menu-list pt-24 pb-8">
                ...
                <li class="mobile-menu-item border-b border-base-gold/20"><a href="${giftHref}" class="${giftCardsActive} block py-5 px-8 text-base-text no-underline text-lg transition-colors duration-300 hover:bg-base-gray/30">Cadeaubonnen</a></li>
                <li class="mobile-menu-item border-b border-base-gold/20"><a href="${aboutHref}" class="${aboutUsActive} block py-5 px-8 text-base-text no-underline text-lg transition-colors duration-300 hover:bg-base-gray/30">Over ons</a></li>
                <li class="mobile-menu-item mobile-menu-cta"><a href="https://basecomfortmassage.setmore.com" target="_blank" class="btn-primary block mt-8 mx-6 py-5 text-center bg-base-olive border border-base-olive text-white no-underline text-base italic font-serif rounded-full hover:bg-base-gold hover:border-base-gold">Boek Nu</a></li>
                ...
                <li class="mobile-menu-item mobile-menu-lang text-center mt-6 px-8">
                    <div class="flex items-center justify-center gap-2">
                        <a href="${activePage === 'home' ? 'index' : activePage}.html" class="text-base-text no-underline text-sm font-sans font-semibold">🇳🇱 NL</a>
                        <span class="text-base-text/40 text-sm">|</span>
                        <a href="../en/${activePage === 'home' ? 'index' : activePage}.html" class="text-base-text/60 no-underline text-sm font-sans transition-opacity duration-300 hover:text-base-text">🇬🇧 EN</a>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="max-w-7xl xl:max-w-[90rem] 2xl:max-w-[110rem] mx-auto">
            ...
            <div class="hidden md:grid grid-cols-3 items-center">
                ...
                <div class="flex gap-7 xl:gap-9 2xl:gap-12 items-center justify-center">
                    ...
                    <a href="${giftHref}" class="desktop-nav ${giftCardsActive} text-base-tan no-underline text-sm xl:text-sm 2xl:text-base font-semibold transition-all duration-300 relative pb-1.5 font-sans hover:opacity-70">Cadeaubonnen</a>
                    <a href="${aboutHref}" class="desktop-nav ${aboutUsActive} text-base-tan no-underline text-sm xl:text-sm 2xl:text-base font-semibold transition-all duration-300 relative pb-1.5 font-sans hover:opacity-70">Over ons</a>
                </div>

                <!-- Right: Language switcher + Book Now -->
                <div class="flex gap-7 xl:gap-9 2xl:gap-12 items-center justify-end">
                    <a href="../en/${activePage === 'home' ? 'index' : activePage}.html" class="language-switcher flex gap-2 items-center text-base-tan hover:opacity-70 transition-opacity no-underline">
                        <span class="text-sm font-sans">🇬🇧 EN</span>
                    </a>
                    <a href="https://basecomfortmassage.setmore.com" target="_blank" class="btn-primary bg-base-olive border border-base-olive text-white py-3 px-7 md:rounded-full xl:py-4 xl:px-9 2xl:py-5 2xl:px-11 text-sm xl:text-sm 2xl:text-base italic font-serif cursor-pointer transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:bg-base-gold hover:border-base-gold no-underline inline-block">Boek Nu</a>
                </div>
            </div>
        </div>
    </nav>`;
